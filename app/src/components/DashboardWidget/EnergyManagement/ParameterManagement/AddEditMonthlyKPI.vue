<template>
    <el-dialog class="power-dialog" width="307px" title="配置能耗指标" :visible.sync="dialogVisibility" @closed="close">
        <el-form ref="form" class="power-form" :model="formData" :rules="rules">
            ...
            <el-form-item label="指标值" prop="value">
                <el-input type="number" v-model="formData.value" placeholder="请输入指标值">
