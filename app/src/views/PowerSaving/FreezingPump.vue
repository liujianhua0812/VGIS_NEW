...
import PumpSelector from "@/components/DashboardWidget/PowerSaving/FreezingPump/PumpSelector.vue";
import PumpInfoCard from "@/components/DashboardWidget/PowerSaving/FreezingPump/PumpInfoCard.vue";
